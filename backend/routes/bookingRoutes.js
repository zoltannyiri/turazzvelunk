...
router.get('/tour/:tourId/waitlist', protect, bookingController.getTourWaitlist);
...
router.put('/waitlist/:id/promote', protect, adminOnly, bookingController.promoteWaitlistBooking);
